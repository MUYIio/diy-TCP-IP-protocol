...
int main (void) {
    ...
    // 注意，如果以下信息输出在DEBUG CONSOLE，可能直接显示出原始序列
    // 在Mac上，可以将launch.json中的externalConsole值改成true
    // 即可在外部终端窗口中显示出正常颜色的字体
    dbg_info(DBG_STYLE_ERROR"error");
    dbg_info(DBG_STYLE_RESET"reset");
    dbg_info(DBG_STYLE_WARNING"warning");
